...
export default function MenubarPage() {
  ...
  return (
    <>
      <h2>Menubar</h2>
      <p>A horizontal menu bar with keyboard-driven navigation — menus open on click and switch on hover once one is open, like a native app menu.</p>

      <InstallSnippet slug="menubar" />

      <section className="pg-section">
        <h3>Usage</h3>
        <ComponentPreview code={`import { Menubar, MenubarMenu, MenubarTrigger, MenubarContent, MenubarItem, MenubarShortcut, MenubarSeparator } from "./ui/menubar/menubar"
import "./ui/menubar/menubar.css"
...
<Menubar>
  <MenubarMenu>
    ...
    <MenubarContent>
      ...
      <MenubarSeparator />
      <MenubarItem onSelect={() => handleAction("print")}>Print…</MenubarItem>
    </MenubarContent>
  </MenubarMenu>
</Menubar>`}>
      ...
      <ApiReference props={[
        { name: "value", type: "string", description: "On MenubarMenu — unique value to identify the menu" },
        { name: "onSelect", type: "(event) => void", description: "On MenubarItem — fires on activation" },
        { name: "disabled", type: "boolean", default: "false", description: "On MenubarItem — skipped by arrow nav, not activatable" },
