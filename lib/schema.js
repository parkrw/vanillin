...
// `URL.canParse` shipped in Safari 17 and Node 18.17. Calling it bare makes the
// *validator* throw on anything older, so a bad URL crashes the form instead of
// failing its check — the one thing a validator must never do.
const canParseUrl =
  typeof URL !== "undefined" && typeof URL.canParse === "function"
