 ...
 *
 * Skipped: manual/server-side operations, virtualization.
 *
...
export function useDataTable({
  ...
  const pageCount = Math.max(1, Math.ceil(flatRows.length / pagination.pageSize))
