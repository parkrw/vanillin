...
export function positionAnchored(anchor, floating, options = {}) {
  ...
  // Clear the [popover] UA `inset: 0`. Leaving right/bottom at 0 over-constrains
  // the box once it has a definite width, and CSS 2.1 §10.3.7 then drops `left`
  // under RTL — the element snaps to the viewport edge instead of the anchor.
