...
| 88  | console-rebrand-nav      | ~L  | [x]    | complete 2026-08-17 on `feat/console-rebrand-nav` (8 commits, no PR); suite 768/771 — Acme Cloud 1.0.0, generic wording, grouped sidebar (collapsed), fake theme toggle, tooltips, row actions, image attachments; owns `site/showcase/console.*` |
