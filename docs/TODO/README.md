...
| 90  | console-route            | ~S  | [ ]    | user 2026-08-18 — Platform nav group open by default (sidebar reads as empty when all collapsed), full-viewport `#console` route, "Open full console" link on home; app/screenshot alternatives rejected |
