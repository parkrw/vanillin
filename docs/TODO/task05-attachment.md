...
- [ ] 2. Demo page `playground/pages/attachment.jsx` (states incl. shimmer + error, sizes, vertical/image variants, actions, scrollable group) + registry `page:` entry. files: `playground/pages/attachment.jsx`, `playground/registry.js`
