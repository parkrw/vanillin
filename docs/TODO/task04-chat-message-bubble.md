...
- [ ] 2. `ui/message/message.jsx` + `message.css` — Message (align: start | end), MessageGroup, MessageAvatar (bottom-anchored, clears footer), MessageContent, MessageHeader, MessageFooter. files: `ui/message/message.jsx`, `ui/message/message.css`
